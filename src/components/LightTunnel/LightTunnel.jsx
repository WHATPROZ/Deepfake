...
export default function LightTunnel({
  ...
  useEffect(() => {
    ...
    u.uCableColor.value[0] = cable[0];
    u.uCableColor.value[1] = cable[1];
    u.uCableColor.value[2] = cable[2];
    const pulse = hexToRgb(pulseColor);
    u.uPulseColor.value[0] = pulse[0];
    u.uPulseColor.value[1] = pulse[1];
    u.uPulseColor.value[2] = pulse[2];
    const tunnel = hexToRgb(tunnelColor);
    u.uTunnelColor.value[0] = tunnel[0];
    u.uTunnelColor.value[1] = tunnel[1];
    u.uTunnelColor.value[2] = tunnel[2];

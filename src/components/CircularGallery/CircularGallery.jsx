...
class Title {
  ...
  createMesh() {
    ...
    this.mesh.position.y = -this.plane.scale.y * 0.5 - textHeight * 0.5 - this.labelGap;
...
class App {
  constructor(
    ...
    this.onResize();
    this.createGeometry();
    this.createMedias(items, bend, textColor, borderRadius, font, repeatItems, itemScale, labelGap, labelScale);
    this.update();
  ...
  createMedias(
    ...
    this.mediasImages = repeatItems ? galleryItems.concat(galleryItems) : galleryItems;
